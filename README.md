...
**redux-toolkit-tutorial** is a simple website base on a tutorial about redux and react.
...
- **Use of react toolkit**
- **Use of dispatch**
- **Using of Async thunk and axios**
...
```sh
  cd my-folder
  git clone https://github.com/Matthieu96Code/redux-toolkit-tutorial.git
```
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/redux-toolkit-tutorial/issues)
